    ...
    <Center w="100%">
      <Box safeArea p="2" py="8" w="90%" maxW="290">
        ...
        <VStack space={3} mt="5">
          ...
          <Button mt="2" colorScheme="indigo" onPress={() => navigation.navigate('Image')}>Sign in</Button>
          <HStack mt="6" justifyContent="center">
            <Text fontSize="sm" color="coolGray.600" _dark={{color: "warmGray.200"}}>I'm a new user.{" "}</Text>
            <Link _text={{color: "indigo.500",fontWeight: "medium",fontSize: "sm"}} onPress={() => navigation.navigate('Sign up')}>Sign Up</Link>
          </HStack>
        </VStack>
      </Box>
    </Center>
